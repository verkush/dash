...
import { NAV_SIDEBAR_LINKS, NAV_SIDEBAR_TEAM_LINKS } from "../libs/navigation";
                ...
                <div className="flex flex-col px-6 pb-4 overflow-y-auto bg-white grow gap-y-5">
                  <div className="flex items-center h-16 shrink-0">
                    <img
                      ...
                      src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/NXP-Logo.svg/927px-NXP-Logo.svg.png?20150315023951"
                      alt="HSE Dev Dashboard"
                    />
                  </div>
                    ...
                    <ul role="list" className="flex flex-col flex-1 gap-y-7">
                      ...
                      <li>
                        ...
                        <ul role="list" className="mt-2 -mx-2 space-y-1">
                          {NAV_SIDEBAR_TEAM_LINKS.map((team) => (
                            <li key={team.name}>
                              <a
                                href={team.href}
                                className={classNames(
        ...
        <div className="sticky top-0 z-40 flex items-center h-16 px-4 bg-white border-b border-gray-200 shadow-sm shrink-0 gap-x-4 sm:gap-x-6 sm:px-6 lg:px-8">
          ...
          <div className="flex self-stretch flex-1 gap-x-4 lg:gap-x-6">
            <form className="relative flex flex-1" action="#" method="GET">
              ...
              <input
                id="search-field"
                className="block w-full h-full py-0 pl-8 pr-0 text-gray-900 border-0 placeholder:text-gray-400 focus:outline-none sm:text-sm"
                placeholder="Search..."
                type="search"
                name="search"
              />
